...
import { ConnectionMode, type NodeLookup, type OnError, type Transform, type ZIndexMode } from '@xyflow/system';
export declare function getVisibleNodes<NodeType extends Node = Node>(nodeLookup: NodeLookup<InternalNode<NodeType>>, transform: Transform, width: number, height: number, buffer?: number): Map<string, InternalNode<NodeType>>;
