...
export declare function getInitialStore<NodeType extends Node = Node, EdgeType extends Edge = Edge>(signals: StoreSignals<NodeType, EdgeType>): {
    ...
    progressiveEdgeBatcher: ProgressiveEdgeBatcher<EdgeType> | null;
    _prevRenderedEdges: Map<string, EdgeLayouted<EdgeType>>;
    ...
    initViewportBatching(): void;
    setViewportUpdateSource(isInternal: boolean): void;
